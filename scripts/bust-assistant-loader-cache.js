...
if (catalog.includes(directRuntimeTags)) {
  console.log('[assistant-runtime] runtime6 scripts already configured');
  process.exit(0);
}

const sourceTag = [runtime5Tags, runtime4Tags, cachedLoaderTag, legacyLoaderTag]
...
console.log('[assistant-runtime] upgraded direct runtime scripts to runtime6');
